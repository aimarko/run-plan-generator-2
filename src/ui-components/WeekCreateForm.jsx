...
export default function WeekCreateForm(props) {
  ...
  const resetStateValues = () => {
    setWeeksToRace(initialValues.weeksToRace);
    setBuildPercent(initialValues.buildPercent);
    setCutbackWeek(initialValues.cutbackWeek);
    setCutbackAmount(initialValues.cutbackAmount);
    setRunsPerWeek(initialValues.runsPerWeek);
    setStartingMileage(initialValues.startingMileage);
    setRunPercents(initialValues.runPercents);
